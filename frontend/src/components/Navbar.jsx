    ...
    <>
      ...
      <nav className="bg-gradient-to-r from-gray-900 to-gray-800 fixed w-full h-16 top-0 z-50 backdrop-blur-md shadow-lg border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-full">
          {/* Left: Logo only (removed hamburger) */}
          ...
          {/* Right: Auth/Profile only (removed search bar) */}
            ...
            {user ? (
              ...
              >
                {userDetails?.avatarUrl ? (
                  ...
                  <span className="w-full h-full flex items-center justify-center text-cyan-400 bg-white">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.121 17.804A13.937 13.937 0 0112 15c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                  </span>
                )}
              </button>
            ) : (
